...
DiSwitch is exempt from this approximation gate because it preserves the exact policy semantics; its acceptance instead requires replay/action equivalence and branch-forward-count regression tests.
