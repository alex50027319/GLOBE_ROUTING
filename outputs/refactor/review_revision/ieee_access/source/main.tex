...
\begin{figure*}[t]
\centering
\fcolorbox{ReviewRed}{white}{\includegraphics[width=0.94\textwidth]{figures/figure_05_literature_coverage.pdf}}
...
\begin{figure*}[t]
\centering
\fcolorbox{ReviewRed}{white}{\includegraphics[width=0.94\textwidth]{figures/figure_02_fusion.pdf}}
...
\begin{figure*}[t]
\centering
\fcolorbox{ReviewRed}{white}{\includegraphics[width=0.94\textwidth]{supplementary_figures/20_failed_candidate_tradeoff.png}}
...
Kyung Eun Kim: conceptualization, methodology, software, validation, formal analysis, investigation, data curation, visualization, and writing---original draft. Howon Lee: conceptualization, supervision, project administration, and writing---review and editing. \AuthorCheck{Both authors must verify the contribution assignments and approve the final version before submission.}

\section*{Funding}
\AuthorCheck{Confirm funding agency and grant number, or the absence of external funding.}

\section*{Data Availability}
The study is accompanied by source code, configuration files, raw episode archives, seed summaries, paired-effect tables, A100 benchmark manifests, operator profiles, figure-source CSV files, and SHA-256 records in the project repository. \AuthorCheck{A public repository URL and archival DOI, or approved access conditions, remain to be supplied.}

\section*{Conflicts of Interest}
The authors declare no conflict of interest. \AuthorCheck{Both authors must verify this declaration before submission.}
...
\AuthorCheck{Author-verified affiliation, biography, and research interests must be supplied.}
