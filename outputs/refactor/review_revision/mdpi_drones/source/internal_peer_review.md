...
6. Confirm ORCID iDs, any applicable funding statement, the data-release identifier, and current IEEE Access submission requirements.

## Strengths

- Clear training/deployment information boundary.
- Semantics-preserving computation reuse is separated from approximate model compression.
