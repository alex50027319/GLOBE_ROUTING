...
\Title{Supplementary Material for ``DiSwitch''}
\Author{Kyung Eun Kim and Howon Lee}\AuthorNames{Kyung Eun Kim and Howon Lee}
\address{Department of Military Digital Convergence, Ajou University, Suwon, Republic of Korea}
\corres{Correspondence: to be completed before submission}
\abstract{This supplement documents experimental provenance, metric semantics, acceptance gates, negative results, and the complete 20-figure latency and reliability analysis supporting the DiSwitch manuscript.}
...
DiSwitch--Fast-DiSwitch reliability & R2 & Paired seed differences; study-defined 0.5 percentage-point non-inferiority floor \\
...
\caption{Candidate decision matrix. DiSwitch improves the duplicated legacy execution without an outcome change; buffering is too small; Early Exit is slower; Fast violates the quality gate.}
