...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `/home/alex/GLOBE_ROUTING-refactor-globe/.claude/.gsd-surface.json`
(sibling to `/home/alex/GLOBE_ROUTING-refactor-globe/.claude/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `/home/alex/GLOBE_ROUTING-refactor-globe/.claude/skills/gsd-*/`.
...
(`~/.claude`), NOT the skills sub-directory (`/home/alex/GLOBE_ROUTING-refactor-globe/.claude/skills`).
...
`/home/alex/GLOBE_ROUTING-refactor-globe/.claude/skills/gsd-*/` because the `claude global` layout has `destSubpath =
...
(i.e. `/home/alex/GLOBE_ROUTING-refactor-globe/.claude/.gsd-surface.json`).
...
<execution_context>
Surface state file: `/home/alex/GLOBE_ROUTING-refactor-globe/.claude/.gsd-surface.json`
Install profile marker: `/home/alex/GLOBE_ROUTING-refactor-globe/.claude/.gsd-profile`
Skill dirs: `/home/alex/GLOBE_ROUTING-refactor-globe/.claude/skills/gsd-*/`
Engine module: `/home/alex/GLOBE_ROUTING-refactor-globe/.claude/gsd-core/bin/lib/surface.cjs`
Cluster definitions: `/home/alex/GLOBE_ROUTING-refactor-globe/.claude/gsd-core/bin/lib/clusters.cjs`
</execution_context>
