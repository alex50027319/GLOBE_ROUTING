...
Reference full template: `/home/alex/GLOBE_ROUTING/.claude/gsd-core/templates/roadmap.md`

## STATE.md Structure

Use template from `/home/alex/GLOBE_ROUTING/.claude/gsd-core/templates/state.md`.
