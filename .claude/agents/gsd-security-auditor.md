...
**Verification depth scales with `asvs_level`** (see @/home/alex/GLOBE_ROUTING-refactor-globe/.claude/gsd-core/references/security-asvs-levels.md for full definitions):
