...
<reference>
@/home/alex/GLOBE_ROUTING-refactor-globe/.claude/gsd-core/references/user-profiling.md
...
Read the user-profiling reference document at `/home/alex/GLOBE_ROUTING-refactor-globe/.claude/gsd-core/references/user-profiling.md` to load:
