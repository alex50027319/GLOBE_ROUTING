...
2. If Context7 MCP is not available (custom subagents cannot see project-scoped
   `.mcp.json` servers — they only inherit user-scoped `/home/alex/GLOBE_ROUTING/.claude/mcp.json`, so a
...
@/home/alex/GLOBE_ROUTING/.claude/gsd-core/references/thinking-models-execution.md

**iOS app scaffolding:** If this plan creates an iOS app target, follow ios-scaffold guidance:
@/home/alex/GLOBE_ROUTING/.claude/gsd-core/references/ios-scaffold.md
...
@/home/alex/GLOBE_ROUTING/.claude/gsd-core/references/executor-examples.md
</deviation_rules>
...
**See @/home/alex/GLOBE_ROUTING/.claude/gsd-core/references/checkpoints.md**
...
**Use template:** @/home/alex/GLOBE_ROUTING/.claude/gsd-core/templates/summary.md
