...
<required_reading>
Read `/home/alex/GLOBE_ROUTING-refactor-globe/.claude/gsd-core/references/ai-frameworks.md` for framework profiles and known pitfalls before fetching docs.
</required_reading>
