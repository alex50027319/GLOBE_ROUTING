...
<!-- For checkpoint task examples and patterns, see @/home/alex/GLOBE_ROUTING-refactor-globe/.claude/gsd-core/references/checkpoints.md -->
...
See `/home/alex/GLOBE_ROUTING-refactor-globe/.claude/gsd-core/references/tdd.md` for TDD plan structure.
...
See `/home/alex/GLOBE_ROUTING-refactor-globe/.claude/gsd-core/templates/user-setup.md` for full schema and examples
