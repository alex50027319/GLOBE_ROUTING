...
ones). Reference: @/home/alex/GLOBE_ROUTING/.claude/gsd-core/references/edge-probe.md.
...
# — NOT the consuming project's git root — falling back to git toplevel / /home/alex/GLOBE_ROUTING/.claude.
...
EDGE_PROBE_JS=$(for _c in \
  ...
  "/home/alex/GLOBE_ROUTING/.claude/gsd-core/bin/lib/edge-probe.cjs" \
  "/home/alex/GLOBE_ROUTING/.claude/bin/lib/edge-probe.cjs"; do
  [ -f "$_c" ] && { echo "$_c"; break; }
done)
...
requirement list). Reference: @/home/alex/GLOBE_ROUTING/.claude/gsd-core/references/prohibition-probe.md — the
...
Use the SPEC.md template from @/home/alex/GLOBE_ROUTING/.claude/gsd-core/templates/spec.md.
