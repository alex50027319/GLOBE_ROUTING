...
```markdown
Read /home/alex/GLOBE_ROUTING-refactor-globe/.claude/agents/gsd-ui-researcher.md for instructions.
...
Template: /home/alex/GLOBE_ROUTING-refactor-globe/.claude/gsd-core/templates/UI-SPEC.md
</output>
...
```markdown
Read /home/alex/GLOBE_ROUTING-refactor-globe/.claude/agents/gsd-ui-checker.md for instructions.
...
@/home/alex/GLOBE_ROUTING-refactor-globe/.claude/gsd-core/references/ui-consideration-probe.md.
...
# (#448) — NOT the consuming project's git root — falling back to git toplevel / /home/alex/GLOBE_ROUTING-refactor-globe/.claude.
...
UI_PROBE_JS=$(for _c in \
  ...
  "/home/alex/GLOBE_ROUTING-refactor-globe/.claude/gsd-core/bin/lib/ui-consideration-probe.cjs" \
  "/home/alex/GLOBE_ROUTING-refactor-globe/.claude/bin/lib/ui-consideration-probe.cjs"; do
  [ -f "$_c" ] && { echo "$_c"; break; }
done)
