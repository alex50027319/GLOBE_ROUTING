...
<required_reading>
@/home/alex/GLOBE_ROUTING/.claude/gsd-core/references/ai-frameworks.md
@/home/alex/GLOBE_ROUTING/.claude/gsd-core/references/ai-evals.md
</required_reading>
...
```markdown
Read /home/alex/GLOBE_ROUTING/.claude/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "/home/alex/GLOBE_ROUTING/.claude/gsd-core/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read /home/alex/GLOBE_ROUTING/.claude/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read /home/alex/GLOBE_ROUTING/.claude/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read /home/alex/GLOBE_ROUTING/.claude/agents/gsd-eval-planner.md for instructions.
