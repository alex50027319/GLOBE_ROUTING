...
```
Agent(
  prompt="Read /home/alex/GLOBE_ROUTING-refactor-globe/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/home/alex/GLOBE_ROUTING-refactor-globe/.claude/gsd-core/templates/SECURITY.md`
