...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = /home/alex/GLOBE_ROUTING-refactor-globe/.claude
                  → checks /home/alex/GLOBE_ROUTING-refactor-globe/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /home/alex/GLOBE_ROUTING-refactor-globe/.claude/gsd-core
                  → writes to /home/alex/GLOBE_ROUTING-refactor-globe/.claude/gsd-core/hooks/
