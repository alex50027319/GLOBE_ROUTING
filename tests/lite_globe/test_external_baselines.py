"""External routing baseline and reporting guarantees."""
...
from implementations.lite_globe.evaluation.baseline_reporting import (
...
def test_baseline_artifacts_include_tables_and_figures(tmp_path: Path) -> None:
    summary_rows = []
                ...
                summary_rows.append(
                    {
                        ...
                        "mean_switch_steps": 0.0,
                        "mean_safe_forward_candidates": 1.0,
    ...
    manifest = write_baseline_artifacts(
        ...
        metadata={"suite": "external_baselines", "mode": "test"},
    )
    ...
    for relative in (
        ...
        "figures/external_baseline_pdr.png",
        "figures/external_baseline_delay_p95.pdf",
        "manifest.json",
    ):
