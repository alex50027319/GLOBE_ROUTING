"""Phase 10: train and evaluate recent external RL routing baselines."""
...
from ..models import GeographicResidualStudentPolicy
...
def _policy(
    ...
    if method == "Phase 8 Geo-Residual KD":
        assert isinstance(policy_or_model, GeographicResidualStudentPolicy)
